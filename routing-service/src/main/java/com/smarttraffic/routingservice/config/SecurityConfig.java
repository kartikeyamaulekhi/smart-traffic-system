...
import com.smarttraffic.routingservice.security.JwtAuthenticationFilter;
 ...
 *
 * This service only VALIDATES tokens signed by auth-service (same shared
 * secret) - /health is public, everything under /api/** requires a valid
