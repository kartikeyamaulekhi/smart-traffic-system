 ...
 * so the readiness endpoint reports UP (the Kafka consumer listener is disabled
 * in the "test" profile so the context starts without a broker - see
 * application.yml). Phase 19 observability.
 */
@SpringBootTest
